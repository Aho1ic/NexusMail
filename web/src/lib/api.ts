import type { Account, Attachment, Draft, DraftInput, Mailbox, Message } from '../types'
...
export const api = {
  ...
  message: (id: number) => request<{ message: Message; attachments: Attachment[] }>(`/api/v1/messages/${id}`),
